        ...
        <div class="container py-4">
            ...
            <div class="p-5 mb-4 bg-body-tertiary rounded-3">
                <div class="container-fluid py-5">
                    <h1 class="display-5 fw-bold">Selamat Datang di Platform Uji Kompetensi SMK Jurusan PPLG 2025!</h1>
            ...
            <div class="row align-items-md-stretch">
                <div class="col-md-6 mb-3">
                    <div class="h-100 p-5 bg-info text-bg-light rounded-3 hover-zoom">
                        <h2>Kalkulator Daring</h2>
                        <p>Swap the background-color utility and add a `.text-*` color utility to mix up the jumbotron look. Then, mix and match with additional component themes and more.</p>
                        <button class="btn btn-outline-light" type="button">Open</button>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="h-100 p-5 bg-body-tertiary border rounded-3 hover-zoom">
                        <h2>To-Do List App</h2>
                        <p>Or, keep it light and add a border for some added definition to the boundaries of your content. Be sure to look under the hood at the source HTML here as we've adjusted the alignment and sizing of both column's content for equal-height.</p>
                        <a href="todo-list-app.php " class="btn btn-outline-secondary" type="button">Open</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="h-100 p-5 bg-body-tertiary border rounded-3 hover-zoom">
                        <h2>Pengelolaan Basis Data</h2>
                        <p>Or, keep it light and add a border for some added definition to the boundaries of your content. Be sure to look under the hood at the source HTML here as we've adjusted the alignment and sizing of both column's content for equal-height.</p>
                ...
                <div class="col-md-6">
                    <div class="h-100 p-5 bg-info text-bg-light rounded-3 hover-zoom">
                        ...
                        <p>Swap the background-color utility and add a `.text-*` color utility to mix up the jumbotron look. Then, mix and match with additional component themes and more.</p>
                        <a href="discount-app.php" class="btn btn-outline-light" type="button">Open</a>
                    </div>
                </div>
            </div>
